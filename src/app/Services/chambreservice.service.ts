...
export class ChambreserviceService {
  ...
  getChambres(): Observable<Chambre[]> {
    ...
    return this._http.get<Chambre[]>(this.apiUrl + 'chambre/retrieve-all',{headers});
  ...
  getChambreById(idChambre: number): Observable<Chambre> {
    ...
    return this._http.get<Chambre>(this.apiUrl +`admin/chambre/retrievechambre/${idChambre}`,{headers});
  }
  //addChambre
  ...
  afficherparnombloc(nomBloc : String):Observable<Chambre>{
    ...
    return this._http.get<Chambre>(this.apiUrl + `admin/chambre/affecterListeChambre/${nomBloc}`,{headers})
  }
